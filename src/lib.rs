...
#[derive(Debug)]
pub struct LinkForgeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl LinkForgeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting LinkForge processing");
    
    let mut processor = LinkForgeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = LinkForgeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = LinkForgeProcessor::new(false);
